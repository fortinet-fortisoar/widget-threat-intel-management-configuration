  ...
  (function () {
    ...
    class widgetConnectorConfigurationComponent {
      ...
      $onInit() {
        ...
        //self.ingestionButtonTitle = self.connectorInfo.ingestion_preferences && !self.CommonUtils.isUndefined(self.connectorInfo.ingestion_preferences.launch_name) ? self.connectorInfo.ingestion_preferences.launch_name : 'Configure Data Ingestion';
        self.hideConfiguration = false;
        //self.tabIndex = self.resolve.tabIndex;
      ...
      initConfiguration(status) {
        ...
        if (!self.selectedAgent || (!self.input.selectedConfiguration.status && !self.input.selectedConfiguration.lastKnownHealthTime)) {
      ...
      // checkIngestionEnable() {
      //   if(!self.CommonUtils.isUndefined(self.connectorInfo.configuration) && self.connectorInfo.configuration.length > 0 && !self.CommonUtils.isUndefined(self.input.selectedConfiguration.status)){
      //       if(self.input.selectedConfiguration.status.toLowerCase() === 'available'){
      //           self.configHealthAvailable = true;
      //       }
      //       else{
      //           self.configHealthAvailable = false;
      //       }
      ...
      //       self.configHealthAvailable = false;
      //   }
      //   //self.configHealthAvailable = (!self.CommonUtils.isUndefined(self.connectorInfo.configuration) && self.connectorInfo.configuration.length > 0 && !self.CommonUtils.isUndefined(self.input.selectedConfiguration.status) && self.input.selectedConfiguration.status.toLowerCase() === 'available') ? true : false;
      // }
      ...
      //   self.dataIngestionService.openWizard(config, self.connectorInfo, null, self.selectedAgent);
      // }
